package com.wtb.hook

import com.wtb.hook.core.CallbackHandler
import com.wtb.hook.core.ClassLoaderUtils
import com.wtb.hook.core.Hook
import com.wtb.hook.utils.LogUtils
...
// DES: 日志打印
fun log(logContent: Any, tag: String=LogUtils.DEFAULT_TAG) {
    LogUtils.debug(tag, logContent)
}
